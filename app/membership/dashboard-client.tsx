      ...
      <div className="flex justify-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div ref={contentRef} className="w-full max-w-[1000px] flex flex-col gap-6 bg-[#EBEBDF] p-4 sm:p-8 rounded-3xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 auto-rows-auto gap-4 sm:gap-6">
            {/* Hero Tile */}
            <div className="md:col-span-2 lg:col-span-2 bg-[#4C050C] text-white rounded-[24px] p-8 relative overflow-hidden flex flex-col justify-end min-h-[380px] shadow-lg transition-transform hover:-translate-y-1">
            ...
            <div className="md:col-span-2 lg:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              {/* 1:1 Inquiry Tile */}
              <div className="bg-white rounded-[24px] p-8 border border-[#4C050C]/10 shadow-sm transition-transform hover:-translate-y-1 flex flex-col justify-between">
              ...
              {/* Talk to AI Tile */}
              <div className="bg-[#4C050C] rounded-[24px] p-8 border border-[#4C050C]/10 shadow-sm transition-transform hover:-translate-y-1 flex flex-col justify-between">
                <div className="flex justify-between items-center mb-6">
                  <div className="flex items-center gap-3">
