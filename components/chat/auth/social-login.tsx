    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <Button
          type="button"
          variant="outline"
          className="bg-[#2c2c2e] border border-[#3a3a3c] text-[#4C050C] hover:bg-[#3a3a3c] hover:text-[#4C050C] hover:border-[#48484a] transition-all duration-200 rounded-2xl h-14 font-medium font-sans"
