  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        ...
        <div>
          <p className="text-xs text-muted-foreground mb-1">성사된 거래</p>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-card border border-border rounded-xl p-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm text-muted-foreground">팀 매출</span>
          </div>
        ...
        <div className="bg-card border border-border rounded-xl p-5 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-sm text-muted-foreground">평균 목표 달성률</span>
          </div>
      ...
      <div className="bg-card border border-border rounded-xl p-5 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-150">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-base font-semibold text-foreground">매출 대비 목표</h3>
            <p className="text-sm text-muted-foreground mt-0.5">개인 성과 비교</p>
          </div>
          <div className="flex items-center gap-4 text-xs">
            <div className="flex items-center gap-1.5">
              <div className="w-2.5 h-2.5 rounded-full bg-chart-1" />
              <span className="text-muted-foreground">매출 (k)</span>
            </div>
            <div className="flex items-center gap-1.5">
              <div className="w-2.5 h-2.5 rounded-full bg-muted-foreground/30" />
              <span className="text-muted-foreground">목표 (k)</span>
            </div>
          </div>
        </div>
      ...
      {/* Team members grid */}
      <div>
        <h3 className="text-base font-semibold text-foreground mb-4">팀원</h3>
